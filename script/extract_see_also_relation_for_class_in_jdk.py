from util.jdk_data_export import export_class_see_also_relation_from_jdk
...
if __name__ == "__main__":
    relation_set = set(export_class_see_also_relation_from_jdk())
    result = __parse_to_json(relation_set)
    write_json_to_file("jdk_see_also_relation_for_class.json", result)
